  ...
  return (
    <div className='card-winter-recommend-container'>
        <div className="card-winter-recommend-container-elements">
          ...
          <RecommendCard statement='I have traveled extensively all over the world, and have to say that my recent excursion to Argentina with Wild Terrains was one of the most fun trips I have taken. Our group was a wonderful mix of independent, travel-loving women of all ages and professions.' name='- lovelace'/>
        </div>
    </div>
  )
}

export default WinterRecommends
