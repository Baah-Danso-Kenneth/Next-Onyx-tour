...
function SummerInstructorInfo() {
const DetailsInfo = [
  {
    brand: BrandImage,
    instructor: LeaderImg,
    name: "Hulio genkins",
    location: "Prestia Hulivalley, Offison",
    statement1: "Hulio - our fabulous Trip Leader for our Argentina Group Trips. Paige was born and raised in the Washington, DC area and first traveled to - and fell in love with - Argentina during her junior year abroad. After taking a leap of faith and relocating to Buenos Aires in 2008, she worked in journalism and communications while nurturing her true passion: discovering the city's best food, drink, and cultural experiences.",
    statement2: "Hulio is passionate about connecting people, telling stories, and spreading love over a delicious meal and fabulous bottle of wine. When she isn't doing that, you can find her working on her podcast, Bad Information, walking her dog Pocho, or decompressing on the beaches of Uruguay. Learn more about Paige below and follow her here. ",
    inspo: "What’s more empowering than becoming aware of your own strengths and who you are as a person?...",
  ...
  return (
    <div>
     ...
     {DetailsInfo.map((item, index)=>(
        <LeaderDetailPage key={index} {...item}/>
     ))}
    </div>
  )
}

export default SummerInstructorInfo
